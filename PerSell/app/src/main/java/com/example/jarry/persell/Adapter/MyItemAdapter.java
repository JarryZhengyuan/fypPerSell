...
/**
 * Created by Jarry on 10/3/2016.
 */
public class MyItemAdapter extends BaseAdapter implements Filterable {
    ...
    public MyItemAdapter(Context context, int resource, ArrayList<Item> objects) {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint != null && constraint.length() > 0) {
                ...
                for (int i = 0; i < mStringFilterList.size(); i++) {
                    ...
                    if ( (String.valueOf(mStringFilterList.get(i).getStatusID()))
